...
namespace kiwi{
    ...
    #define INFOD(...)			kiwi::__log_func(__FILE__, __LINE__, kiwi::LogLevel::Debug, __VA_ARGS__)
    #define INFOV(...)			kiwi::__log_func(__FILE__, __LINE__, kiwi::LogLevel::Verbose, __VA_ARGS__)
    #define INFO(...)			kiwi::__log_func(__FILE__, __LINE__, kiwi::LogLevel::Info, __VA_ARGS__)
    #define INFOW(...)			kiwi::__log_func(__FILE__, __LINE__, kiwi::LogLevel::Warning, __VA_ARGS__)
    #define INFOE(...)			kiwi::__log_func(__FILE__, __LINE__, kiwi::LogLevel::Error, __VA_ARGS__)
    #define INFOF(...)			kiwi::__log_func(__FILE__, __LINE__, kiwi::LogLevel::Fatal, __VA_ARGS__)
